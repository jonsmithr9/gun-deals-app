  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-8 pb-12">
        <div className="mb-10">
          <img src={productInfo?.image} alt={productInfo?.title} className="w-full max-w-md mx-auto h-64 object-cover rounded-3xl" />
          <h1 className="text-3xl font-bold mt-6 mb-2 text-center">{productInfo?.title}</h1>
