...
export default function Home() {
  ...
  const deals = [
    { 
      ...
      fallbackImage: "https://picsum.photos/id/180/600/400",
      rating: 4.8, 
      shipping: 12.99, 
      fflFee: 25 
    },
    { 
      ...
      fallbackImage: "https://picsum.photos/id/107/600/400",
      rating: 4.9, 
      shipping: 19.99, 
      fflFee: 0 
    },
    { 
      ...
      fallbackImage: "https://picsum.photos/id/106/600/400",
      rating: 4.7, 
      shipping: 9.99, 
      fflFee: 0 
    },
    { 
      ...
      fallbackImage: "https://picsum.photos/id/1015/600/400",
      rating: 4.6, 
      shipping: 8.99, 
      fflFee: 25 
    },
    { 
      ...
      fallbackImage: "https://picsum.photos/id/201/600/400",
      rating: 4.8, 
      shipping: 14.99, 
      fflFee: 25 
    },
    { 
      ...
      fallbackImage: "https://picsum.photos/id/1074/600/400",
      rating: 4.5, 
      shipping: 24.99, 
      fflFee: 0 
    },
            ...
            return (
              ...
              >
                ...
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.src = deal.fallbackImage || 'https://picsum.photos/id/180/600/400';
                  }}
                />
